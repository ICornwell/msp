...
import { ReComponentCommonProps, ReComponentDataFunctionContext, ReComponentSystemProps } from '../../renderEngine/components/ReComponentProps.js';
...
import { RDDTOf, ReUiPlanElement, ReUiPlanElementSetMember } from '../../renderEngine/UiPlan/ReUiPlan.js';
// ============================================
// Table Props
// ============================================
...
function Table<TData extends FluxorData<any> = FluxorData<any>>(
  ...
  function resolveRenderer(renderer: any, col: any, info: any): React.ReactElement | null {
    if (Array.isArray(renderer) && renderer.every(r => r.options?.isReUIPlanElement)) {
      ...
      const element = (((CreateReUiPlanComponent(
        ...
        .withValueBinding((data:ReComponentDataFunctionContext<RDDTOf<CNTX>, LDDTOf<CNTX>>) => col.accessorFn ? col.accessorFn(data.localData) : data.localData?.[col.accessorKey])) as any)
        .build({})
      return (
      <>
