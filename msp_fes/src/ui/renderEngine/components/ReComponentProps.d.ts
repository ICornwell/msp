...
export type ReComponentReBinder<C extends CNTX<any, any, FluxorData<any>, FluxorData<any>, any>, LDDT2 extends FluxorData<any>> = string | ((context: ReComponentDataFunctionContext<DataOf<RDDTOf<C>>, DataOf<LDDTOf<C>>>) => DataOf<LDDT2> | undefined);
