    ...
    const importMap = {
      ...
      ,
        "@azure/msal-common": async () => {
          let pkg = await import("__mf__virtual/host__prebuild___mf_0_azure_mf_1_msal_mf_2_common__prebuild__.js");
            return pkg;
        }
      ,
      ...
      ,
        "msp_ui_common/uiLib/renderEngine": async () => {
          let pkg = await import("__mf__virtual/host__prebuild__msp_ui_common_mf_1_uiLib_mf_1_renderEngine__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
      ...
      ,
        "semver": async () => {
          let pkg = await import("__mf__virtual/host__prebuild__semver__prebuild__.js");
            return pkg;
        }
