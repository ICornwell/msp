...
const mfPort = parseInt(process.env['VITE_PORT'], 10) || Ports.modules['lloydsMsg-lloydsMsgService-1.0.0-default'].ui;
...
export default defineConfig({
  plugins: [
    svgr({ svgrOptions: {} }),
    federation({
      filename: 'lloydsMsg_remoteEntry.js',
      exposes: {
  //      './LloydsMsgResourcesFeature': './src/uiElements/features/tabs/lloydsMsgResources/LloydsMsgResourcesFeature.tsx',
  //      './LloydsMsgSettingsFeature': './src/uiElements/features/blades/lloydsMsgConfigWiz/lloydsMsgSettingsFeature.tsx',
      },
      name: 'lloydsMsg',
      shared: mfShared,
    }),
