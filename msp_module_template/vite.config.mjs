...
const mfPort = parseInt(process.env['VITE_PORT'], 10) || Ports.modules['module_template-MainService-1.0.0-default'].ui;
...
export default defineConfig({
  plugins: [
    svgr({ svgrOptions: {} }),
    federation({
      filename: 'module_template_remoteEntry.js',
      exposes: {
 //       './Module_TemplateResourcesFeature': './src/uiElements/features/tabs/module_templateResources/Module_TemplateResourcesFeature.tsx',
//        './Module_TemplateSettingsFeature': './src/uiElements/features/blades/module_templateConfigWiz/module_templateSettingsFeature.tsx',
      },
