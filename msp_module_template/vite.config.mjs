...
const mfPort = parseInt(process.env['VITE_PORT'], 10) || Ports.modules['moduleX-moduleXService-1.0.0-default'].ui;
...
export default defineConfig({
  plugins: [
    svgr({ svgrOptions: {} }),
    federation({
      filename: 'moduleX_remoteEntry.js',
      exposes: {
  //      './ModuleXResourcesFeature': './src/uiElements/features/tabs/moduleXResources/ModuleXResourcesFeature.tsx',
  //      './ModuleXSettingsFeature': './src/uiElements/features/blades/moduleXConfigWiz/moduleXSettingsFeature.tsx',
      },
      name: 'moduleX',
      shared: mfShared,
    }),
