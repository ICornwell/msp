...
export function mspUiCommonExportCode(): string {
  return `
    ...
    export const LabelFrame = pick('LabelFrame');
    ...
    export const StatusLabel = pick('StatusLabel');
    export const Stepper = pick('Stepper');
    ...
    export const registerLinkClickStrategy = pick('registerLinkClickStrategy');
