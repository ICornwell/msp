...
const mockUserData: Record<string, ViewDataContent<UserWorkData[]>> = {
  ...
  'ian@smallwalrus.com': {
    ...
    content: [{
      ...
      link_type: 'Review',
      link_deadline: new Date('2026-04-25T10:00:00Z'),
      link_slaDueDate: new Date('2026-04-18T10:00:00Z'),
      link_name: 'Reviewer',
    ...
    },
  {
      ...
      link_type: 'Deploy',
      link_deadline: new Date('2026-04-28T10:00:00Z'),
      link_slaDueDate: new Date('2026-04-21T10:00:00Z'),
      link_name: 'DevOps',
