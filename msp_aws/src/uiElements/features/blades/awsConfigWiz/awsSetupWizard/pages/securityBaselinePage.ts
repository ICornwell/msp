...
import type { builder4 as wizPage3 } from '../awsSetupWizardContent';
        ...
        .showingItem.fromComponentElement(LabelFrame)
          ...
          .containingElementSet()
            ...
            .showingItem.fromComponentElement(Columns)
              ...
              .containingElementSet()
                .usingFluxor(awsSecurityFluxorData, ctx => ctx.localData.desiredState?.security ?? {})
