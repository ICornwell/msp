...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@azure/msal-browser": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_azure_mf_1_msal_mf_2_browser__prebuild__.js");
            return pkg;
        }
      ,
        "@azure/msal-common": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_azure_mf_1_msal_mf_2_common__prebuild__.js");
            return pkg;
        }
      ,
        "@azure/msal-react": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_azure_mf_1_msal_mf_2_react__prebuild__.js");
            return pkg;
        }
      ,
        "@emotion/cache": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_emotion_mf_1_cache__prebuild__.js");
            return pkg;
        }
      ,
        "@emotion/react": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_emotion_mf_1_react__prebuild__.js");
            return pkg;
        }
      ,
        "@emotion/react/jsx-runtime": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_emotion_mf_1_react_mf_1_jsx_mf_2_runtime__prebuild__.js");
            return pkg;
        }
      ,
        "@emotion/styled": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_emotion_mf_1_styled__prebuild__.js");
            return pkg;
        }
      ,
        "@mui/icons-material": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_mui_mf_1_icons_mf_2_material__prebuild__.js");
            return pkg;
        }
      ,
        "@mui/material": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_mui_mf_1_material__prebuild__.js");
            return pkg;
        }
      ,
        "@mui/styled-engine": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_mui_mf_1_styled_mf_2_engine__prebuild__.js");
            return pkg;
        }
      ,
        "@mui/system": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild___mf_0_mui_mf_1_system__prebuild__.js");
            return pkg;
        }
      ,
        "msp_ui_common": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__msp_ui_common__prebuild__.js");
            return pkg;
        }
      ,
        "msp_ui_common/uiLib": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__msp_ui_common_mf_1_uiLib__prebuild__.js");
            return pkg;
        }
      ,
        "msp_ui_common/uiLib/behaviours": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__msp_ui_common_mf_1_uiLib_mf_1_behaviours__prebuild__.js");
            return pkg;
        }
      ,
        "msp_ui_common/uiLib/comms": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__msp_ui_common_mf_1_uiLib_mf_1_comms__prebuild__.js");
            return pkg;
        }
      ,
        "msp_ui_common/uiLib/components": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__msp_ui_common_mf_1_uiLib_mf_1_components__prebuild__.js");
            return pkg;
        }
      ,
        "msp_ui_common/uiLib/contexts": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__msp_ui_common_mf_1_uiLib_mf_1_contexts__prebuild__.js");
            return pkg;
        }
      ,
        "msp_ui_common/uiLib/hooks": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__msp_ui_common_mf_1_uiLib_mf_1_hooks__prebuild__.js");
            return pkg;
        }
      ,
        "msp_ui_common/uiLib/renderEngine": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__msp_ui_common_mf_1_uiLib_mf_1_renderEngine__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__react__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom/client": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__react_mf_2_dom_mf_1_client__prebuild__.js");
            return pkg;
        }
      ,
        "react/jsx-dev-runtime": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__react_mf_1_jsx_mf_2_dev_mf_2_runtime__prebuild__.js");
            return pkg;
        }
      ,
        "react/jsx-runtime": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__react_mf_1_jsx_mf_2_runtime__prebuild__.js");
            return pkg;
        }
      ,
        "semver": async () => {
          let pkg = await import("__mf__virtual/pamela__prebuild__semver__prebuild__.js");
            return pkg;
        }
      ...
      const usedShared = {
        ...
        ,
          "semver": {
            ...
            async get () {
              if (false) {
                throw new Error(`Shared module '${"semver"}' must be provided by host`);
              }
              usedShared["semver"].loaded = true
              const {"semver": pkgDynamicImport} = importMap
              const res = await pkgDynamicImport()
              const exportModule = {...res}
              // All npm packages pre-built by vite will be converted to esm
              // removed code below
