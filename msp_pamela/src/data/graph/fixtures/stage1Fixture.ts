...
export function buildPamelaStage1Fixture() {
  const artefacts: Stage1Artefact[] = [
    { id: 'ent_coverstar', name: 'CoverStar', kind: 'enterprise', description: 'Insurance enterprise', context: 'enterprise-context', provenance: 'fixture' },
  ...
  const assertions: Stage1Assertion[] = [
    { id: 'asrt_001', name: 'CoverStar has name', kind: 'assertion', subject: 'ent_coverstar', predicate: 'hasName', object: 'CoverStar', polarity: 'positive', context: 'enterprise-context', provenance: 'fixture' },
    ...
    { id: 'asrt_010', name: 'Enterprise offers package', kind: 'assertion', subject: 'ent_coverstar', predicate: 'offers', object: 'prod_sme_package', polarity: 'positive', context: 'enterprise-context', provenance: 'fixture' },
  ...
  const relations: Stage1Relation[] = [
    { id: 'rel_001', name: 'CoverStar has assertion 001', kind: 'relation', sourceId: 'ent_coverstar', relationType: 'hasAssertion', targetId: 'asrt_001' },
