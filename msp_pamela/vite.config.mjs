...
const mfPort = parseInt(process.env['VITE_PORT'], 10) || Ports.modules['pamela-pamelaMainService-1.0.0-default'].ui;
...
export default defineConfig({
  plugins: [
    svgr({ svgrOptions: {} }),
    federation({
      filename: 'pamela_remoteEntry.js',
      exposes: {
 //       './PamelaResourcesFeature': './src/uiElements/features/tabs/pamelaResources/PamelaResourcesFeature.tsx',
//        './PamelaSettingsFeature': './src/uiElements/features/blades/pamelaConfigWiz/pamelaSettingsFeature.tsx',
      },
      name: 'pamela',
      shared: mfShared,
    }),
